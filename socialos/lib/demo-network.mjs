...
export const DEMO_NETWORK_CONTACTS = Object.freeze([
  {
    ...
    name: 'Minghan Xiao',
    tags: ['london-hackathon', 'imperial', 'organiser', 'builder-community', 'tianjin'],
    notes: 'London hackathon organiser at Imperial College. From Tianjin, China. Very nice guy.',
    ...
    interactions: [
      ...
      },
      {
        ...
        summary: 'Talked about builder communities, operator dashboards, and using SocialOS for follow-up.',
        evidence: 'Shared his X and LinkedIn and felt like a natural design-partner contact.',
      },
    ],
  },
  {
    ...
    interactions: [
      {
        ...
        evidence: 'Shared context around community building and the Peter / OpenClaw interview.',
      },
    ],
  },
  {
    ...
    notes: 'Independent lawyer focused on cross-border and intellectual property work. Met through a Chamber of Commerce event in Chengdu. Later visited her office and she treated me to a meal.',
    ...
    interactions: [
      {
        ...
        evidence: 'Works as an independent lawyer with international and IP focus.',
      },
    ],
  },
  {
    ...
    name: 'James Wu',
    tags: ['nvidia', 'industry', 'entrepreneurship', 'sf', 'tianjin-university'],
    notes: 'Vice President at NVIDIA. Met in San Francisco in summer 2025 at iHealth. Tianjin University alumnus who shared his entrepreneurship story and how he entered NVIDIA.',
    ...
    interactions: [
      {
        ...
        evidence: 'Talked about entrepreneurship, NVIDIA, and the Tianjin University connection.',
      },
    ],
  },
  {
    ...
    interactions: [
      {
        ...
        evidence: 'Strong Bristol teaching collaboration and practical course delivery.',
      },
    ],
  },
  {
    ...
    name: 'James Sibson',
    tags: ['babcock', 'defence', 'research-industry', 'exeter'],
  ...
  },
  {
    ...
    tags: ['bath', 'chemical-engineering', 'research-industry', 'exeter'],
    notes: 'Met on the same Exeter research-industry programme. She is now a lecturer in chemical engineering at Bath.',
    ...
    interactions: [
      {
        ...
        evidence: 'Chemical engineering lecturer at Bath with shared research-industry context.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    notes: 'Senior Lecturer at the University of Bristol. We worked on the same MDM3 course.',
  ...
  },
  {
    ...
    notes: 'Lecturer at the University of Bristol. Met in the EngiMath staff kitchen during a dynamics workshop. Shared her first-year experiences. Office is in the Merchant Venturers Building.',
